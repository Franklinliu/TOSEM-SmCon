...
from speccon.specAutomata import SMT_ImplyTwoPredicateSets, SMT_SAT, translate2Z3exprFromPredSet
        ...
        for s_left in S:
            for s_right in S:
                for a in s_left:
                    ...
                    vc = "And({}, And({}, {}))".format(inv_s_left, q_a, inv_s_right)
                    if SMT_SAT(self.variables, vc):
                        self.addTransition(node_mapping[s_left], a, node_mapping[s_right])
